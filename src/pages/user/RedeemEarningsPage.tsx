            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-8 relative overflow-hidden">
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative group">
                        <div className="absolute inset-y-0 left-4 flex items-center text-slate-400 font-bold text-xl group-focus-within:text-emerald-500 transition-colors pointer-events-none">
                            {currency}
                        </div>
                        <input
                            type="number"
