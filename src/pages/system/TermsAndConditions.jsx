        ...
        <div className="min-h-screen bg-slate-50 p-8">
            <div className="max-w-3xl mx-auto bg-surface p-6 rounded-xl shadow-md">
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">2. User Responsibilities</h2>
                    <p>
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">3. Privacy and Data Protection</h2>
                    <p>
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">4. Limitation of Liability</h2>
                    <p>
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">5. Dispute Resolution</h2>
                    <p>
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">6. Contact Information</h2>
                    <p>
