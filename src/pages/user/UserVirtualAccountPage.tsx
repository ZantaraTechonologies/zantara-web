    ...
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8 animate-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div className="bg-slate-950 rounded-2xl p-8 sm:p-10 text-white space-y-10 relative overflow-hidden shadow-2xl shadow-slate-900/40">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-[80px] -mr-24 -mt-24"></div>
                    
                    <div className="relative z-10 flex items-center justify-between">
                        <div className="w-14 h-14 bg-emerald-500/10 rounded-xl flex items-center justify-center text-emerald-400 border border-emerald-500/20">
                            <Building2 size={28} />
                        </div>
                        <div className="text-right">
                            <p className="text-emerald-400 font-bold uppercase tracking-[0.2em] text-[9px]">Node Status</p>
                ...
                <div className="space-y-10">
                    <div className="bg-emerald-50 rounded-2xl p-6 sm:p-8 border border-emerald-100 flex items-start gap-4">
                        <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center text-emerald-500 shadow-sm shrink-0">
                            <Zap size={28} strokeWidth={2.5} />
                        </div>
                        <div className="space-y-1.5">
                            <h3 className="text-base font-bold text-slate-900">Instant Settlement</h3>
