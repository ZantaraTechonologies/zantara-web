        ...
        <div className="space-y-6 pb-20 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-8">
                <div>
                    ...
                    <h1 className="text-3xl font-black text-slate-900 tracking-tighter">Service Center</h1>
                ...
                <div className="bg-surface border border-slate-100 p-4 rounded-3xl backdrop-blur-md flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-black text-slate-900 mt-1 uppercase tracking-tighter">Synchronized & Live</p>
                    </div>
                </div>
            </div>

            {/* Guided Workflow */}
            <div className="bg-gradient-to-r from-indigo-500/5 via-slate-100 to-slate-100 border border-indigo-500/10 rounded-3xl p-6 overflow-hidden">
                        ...
                        return (
                            ...
                            >
                                <div className={`w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-black mb-3 ${
                                    isActive ? 'bg-indigo-500 text-slate-950' : 'bg-slate-100 text-slate-500'
                                }`}>
                                    {step}
                                </div>
                                <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${isActive ? 'text-indigo-400' : 'text-slate-900'}`}>{label}</p>
            ...
            {/* Tab Content Area */}
            <div className="min-h-[500px] bg-surface border border-slate-100 rounded-3xl p-1">
