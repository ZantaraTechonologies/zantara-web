    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-surface rounded-2xl p-6 shadow-sm border border-slate-50 flex flex-col justify-between min-h-[140px]">
                ...
                <div className="bg-surface rounded-2xl p-6 shadow-sm border border-slate-50 flex flex-col justify-between min-h-[140px]">
                    ...
                    <div className="flex items-center justify-between gap-4 bg-slate-50 p-2 pl-4 rounded-xl border border-slate-100 mt-2">
                        ...
                        <button
                            onClick={copyLink}
                            className="bg-brand-emerald text-white px-4 py-2 rounded-lg font-bold text-[10px] uppercase tracking-widest hover:bg-brand-emerald-600 transition-all shadow-btn active:scale-95"
                        >
                            Copy
                        </button>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                {/* History Table */}
                <div className="lg:col-span-8 bg-surface rounded-2xl shadow-sm border border-slate-50 overflow-hidden">
                ...
                <div className="lg:col-span-4 bg-brand-mint/60 rounded-2xl p-8 text-brand-navy h-fit shadow-card border border-brand-emerald/20 relative overflow-hidden">
                    ...
                    <ul className="space-y-10 relative z-10">
                        <li className="flex gap-5">
                            ...
                            <div>
                                <p className="font-bold text-brand-navy uppercase text-[11px] tracking-widest">Deploy Link</p>
                                <p className="text-slate-600 text-xs mt-1 font-medium leading-relaxed">Transmit your unique identifier via any secure channel.</p>
                            </div>
                        </li>
                        <li className="flex gap-5">
                            <span className="flex-shrink-0 w-10 h-10 bg-brand-emerald-100/60 text-emerald-500 rounded-2xl flex items-center justify-center font-bold text-lg border border-brand-emerald/20 italic">02</span>
                            <div>
                                <p className="font-bold text-brand-navy uppercase text-[11px] tracking-widest">Identity Linked</p>
                                <p className="text-slate-600 text-xs mt-1 font-medium leading-relaxed">New user authenticates using your specific referral hash.</p>
                            </div>
                        </li>
                        <li className="flex gap-5">
