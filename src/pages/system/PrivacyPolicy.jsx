    ...
    return (
        <div className="min-h-screen bg-slate-50 p-8">
            <div className="max-w-3xl mx-auto bg-surface p-6 rounded-xl shadow-md">
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">3. Data Usage</h2>
                    <p>
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">4. Data Retention</h2>
                    <p>
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">5. User Rights</h2>
                    <p>
                ...
                <section className="mt-6">
                    <h2 className="text-2xl font-semibold text-slate-800">6. Data Security</h2>
                    <p>
