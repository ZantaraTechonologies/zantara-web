    ...
    return (
        <footer id="contact" className="bg-surface border-t border-slate-100 pt-20 pb-10">
            <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                ...
                <div>
                    <h5 className="font-black text-brand-navy text-sm uppercase tracking-widest mb-6">Products</h5>
                    <ul className="space-y-4">
                        <li><Link to="/login" className="text-slate-500 hover:text-brand-emerald font-medium text-sm transition-colors">Digital Wallet</Link></li>
                        <li><Link to="/login" className="text-slate-500 hover:text-brand-emerald font-medium text-sm transition-colors">Data & Airtime</Link></li>
                        <li><Link to="/login" className="text-slate-500 hover:text-brand-emerald font-medium text-sm transition-colors">TV Subscriptions</Link></li>
                        <li><Link to="/login" className="text-slate-500 hover:text-brand-emerald font-medium text-sm transition-colors">Electricity Bills</Link></li>
                    </ul>
                </div>

                <div>
                    <h5 className="font-black text-brand-navy text-sm uppercase tracking-widest mb-6">Company</h5>
                    <ul className="space-y-4">
                        <li><Link to="/privacy-policy" className="text-slate-500 hover:text-brand-emerald font-medium text-sm transition-colors">Privacy Policy</Link></li>
