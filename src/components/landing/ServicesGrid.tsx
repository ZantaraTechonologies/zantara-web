        ...
        <section id="services" className="py-12 md:py-16 bg-surface">
            <div className="mx-auto max-w-7xl px-6">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <span className="text-[10px] font-black uppercase tracking-[0.2em] text-brand-emerald">Core Infrastructure</span>
                    <h2 className="mt-4 text-4xl md:text-5xl font-black text-brand-navy tracking-tighter">Everything You Need.</h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, idx) => (
                        <Link 
                            to="/login"
                            key={idx}
                            className={`bg-surface rounded-[2rem] p-8 border border-slate-100 shadow-card hover:shadow-card-hover transition-all duration-300 group block ${service.hoverBorder} transform hover:-translate-y-1`}
                        >
