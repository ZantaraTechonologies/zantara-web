            ...
            <div className="w-full max-w-md bg-surface rounded-3xl shadow-card p-6 sm:p-8 border border-slate-100">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-slate-700 block">Operator ID</label>
                    ...
                    <p className="text-center text-slate-500 font-medium">
                        <Link to="/login" title="Public Portal" className="text-brand-emerald font-bold hover:text-brand-emerald-600 transition-colors">
